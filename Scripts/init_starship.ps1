...
$null = New-Module starship {
    ...
    function global:prompt {
        ...
        $promptText = if ($script:TransientPrompt) {
            ...
            Invoke-Native -Executable 'K:\Program Files (x86)\starship\bin\starship.exe' -Arguments $arguments
        }
    ...
    Set-PSReadLineOption -ContinuationPrompt (
        Invoke-Native -Executable 'K:\Program Files (x86)\starship\bin\starship.exe' -Arguments @(
            "prompt",
            "--continuation"
        )
    )
